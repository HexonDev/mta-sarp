...
local blurHShader, blurVShader, brightPassShader, addBlendShader


function switchBloomShader(state)
	print("asd4")
	if state then
		print("asd1")
		-- Version check
        ...
        brightPassShader,tecName = dxCreateShader( "assets/brightPass.fx" )
		outputDebugString( "brightPassShader is using technique " .. tostring(tecName) )

        addBlendShader,tecName = dxCreateShader( "assets/addBlend.fx" )
