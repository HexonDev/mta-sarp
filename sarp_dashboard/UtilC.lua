...
function dxDrawMenuButton(key, label, x, y, w, h, buttonColor, activeColor, textColor, font, textAlign1, textAlign2, imagePath, imageW, imageH, imageColor)
	lastActiveDirectX = activeDirectX
    activeDirectX = activeButton
...
function dxDrawMenuButtonWithBorder(key, label, x, y, w, h, buttonColor, activeColor, textColor, font, textAlign1, textAlign2, imagePath, imageW, imageH, imageColor)
	lastActiveDirectX = activeDirectX
    activeDirectX = activeButton
