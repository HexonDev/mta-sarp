...
function getInfo ( resource )
{
	...
	getResourceInfo( resource,
        function ( result ) /* called when the results arrive, each result in a seperate variable */
        {
            ...
            var html = "Állapot: " + resState + "<br/>";
            if ( result.failurereason != "" )
                html += "Sikertelen betöltés indoka: " + result.failurereason + "<br/>";
            if ( result.state == "running" )
            {
                html += "Elindítva: " + result.starttime + "<br/>";
            }
            else
                html += "Utoljára elindítva: " + result.starttime + "<br/>";

            html += "Betöltve: " + result.loadtime + "<br/>";

			if ( result.author != false )
				html += "Készítő: " + result.author + "<br/>";
			if ( result.version != false )
				html += "Verzió: " + result.version + "<br/>";
